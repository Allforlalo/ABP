        ...
        <div class="col-md-6">
            <div class="card shadow-lg">
                ...
                <div class="card-body p-4">
                    <form novalidate action="{{ route('clientes.update', $cliente->id_cliente) }}" method="POST" class="edit-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id_persona" name="id_persona">
                                ...
                                @foreach($personas as $persona)
                                    <option value="{{ $persona->id_persona }}" {{ old('id_persona', $cliente->id_persona) == $persona->id_persona ? 'selected' : '' }}>
