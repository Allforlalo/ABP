...
@section('content')
    ...
    <div class="card bg-dark text-white">
        <div class="card-body">
            <form novalidate action="{{ route('ponteglamping.update', $ponteglamping->glamping) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label class="form-label">Glamping</label>
                    <input type="number" name="glamping" class="form-control" value="{{ $ponteglamping->glamping }}">
                </div>
                <div class="mb-3">
