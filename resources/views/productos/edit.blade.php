        ...
        <div class="col-md-6">
            <div class="card shadow-lg">
                ...
                <div class="card-body p-4">
                    <form novalidate action="{{ route('productos.update', $producto->id_producto) }}" method="POST" class="edit-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" min="0.01" class="form-control" id="precio" name="precio" value="{{ old('precio', $producto->precio) }}">
                        </div>
                        <div class="mb-3">
